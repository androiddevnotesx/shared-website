  ...
  return (
    ...
    >
      ...
      <span>
        ...
        {/*<br />*/}
        {/*<h1>{title}</h1>*/}
        <span className='text-xs font-sans  text-gray-500 dark:text-gray-300 '>Made by  <a href='https://github.com/androiddevnotes' className='underline '>{BLOG.AUTHOR}</a>.</span>
      </span>
    </footer>
  )
}
