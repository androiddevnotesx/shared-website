...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '390248def603463ab4dd96a058aa7d10',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Android Dev Notes', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Content is contributed by Android Developers', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.androiddevnotes.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Android, Development, Coding, Programming, Mobile, Apps', // 网站关键字
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'awesomedevnotes@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/androiddevnotes', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/androiddevnotes', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  ADSENSE_GOOGLE_SLOT: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT || '', // 谷歌广告位ID e.g 1234567890
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Android Dev Notes', // 站点标题 ，被notion中的页面标题覆盖
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || 'Android Dev Notes is a blog dedicated to providing developers with the latest news, tips, and tutorials on Android app development. Follow us for articles and insights on Android development trends, best practices, and more.',
  ...
  PRIVACY_POLICY_URL: process.env.NEXT_PUBLIC_PRIVACY_POLICY_URL || 'https://www.androiddevnotes.com/privacy-policy'
}
